...
Отображает список товаров введённых в базу данных и удолетворяющих следующим условиям:
...
3) Кнопка "Добавить магазин" (только для сотрудников):
   обеспечивает переход к странице .
...
Отображение полей ввода для создание новой категории и позволяет
1) Кнопка "Создать":
